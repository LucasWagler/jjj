...
use crate::{app::AppSet, errors::ErrorEvent, screens::Screen};

use super::prelude::*;

pub fn plugin(app: &mut App) {
    app.register_type::<ErrorPopup>();

    app.add_systems(OnEnter(Screen::Interface), ErrorPopup::init);
    app.add_systems(OnExit(Screen::Interface), ErrorPopup::remove);
...
impl ResourceWidget for ErrorPopup {}
